...
//    lazy var persistentContainer: NSPersistentCloudKitContainer = {
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
//        let container = NSPersistentCloudKitContainer(name: "GreetingCard")
        let container = NSPersistentContainer(name: "GreetingCard")
